...
#define pfd(k,x) cout<<fixed<<setprecision(k)<<x;
/*******
int main () {
    int c;
   double f =3.14159;
...
{
    int i,j,a,b,c;
    double ta,k,ia,oa,a1,a2,a3;
    while(sf3(a,b,c)!=EOF)
    {
        k=(a+b+c)*0.5;
        ta=1.0*sqrt(k*(k-a)*(k-b)*(k-c));
        double r1=1.0*ta/k;
        double r2=(a*b*c*1.0)/(4.0*ta);
        ia=3.1415926535897*(r1*r1);
        oa=3.1415926535897*(r2*r2);
        a1=oa-ta;
        a2=ta-ia;
        a3=ia;
        pfd(4,a1);
